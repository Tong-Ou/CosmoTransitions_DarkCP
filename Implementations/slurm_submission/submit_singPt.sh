...
# via argument {1}
FILE="outputs/full_potential_cpv/wrap_up/ma5-1"
OUTPATH="outputs/full_potential_cpv/wrap_up/ma5-1_pt/full_potential/"
python singPt_cpv.py $FILE $OUTPATH
#mkdir -p $OUTPATH
