...
paras = np.load('outputs/test_0.npy')
index = 0
fig = plt.figure()
for para in paras:
  ...
  mt.plotPhasesPhi()
  #plt.show()
  plt.savefig('outputs/scan_models/phi_T_%s.png' % index)
  plt.clf()
  
  #plt.figure()
  mt.plotPhases2D()
  #plt.show()
  plt.savefig('outputs/scan_models/vs_vh_%s.png' % index)
  plt.clf()
  ...
  plt.savefig('outputs/scan_models/S_T_%s.png' % index)
